...
const hangleLectureProgress= async(lectureId) =>{
     await updateLectureProgress({courseId,lectureId})
     refetch();
}
const handleSelectLecture=(lecture)=>{
  setCurrentLecture(lecture);
  hangleLectureProgress(lecture._id)
}
    ...
    <div className='max-w-7xl mx-auto p-4 '>
     ...
     <div className='flex justify-between mb-4'> 
      ...
      <div className='flex flex-col md:flex-row gap-6'>
        ...
        <div>
        {/* <video 
        src={currentLecture?.videroUrl || initialLecture.videroUrl}
        className='w-full h-auto md:rounded:lg'
        onPlay={()=>hangleLectureProgress(currentLecture?._id || initialLecture._id)}
        /> */}
        <video 
...
/>
          ...
          {/*Display current watching lecturre title*/}
           <div className='mt-2 '>
