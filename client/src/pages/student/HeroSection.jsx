...
//   return (
//     <div className="relative bg-gradient-to-r from-blue-500 bg-indigo-600 dark:from-gray-800 dark:to-gray-900 py-24 text-center">
//       <div>
...
//           <Button
//             type="submit"
//             className="bg-blue-600 dark:bg-blue-700 text-white px-6 py-3 rounded-full hover:bg-blue-700"
//           >
//             Search
//           </Button>
//         </form>
//         <Button className="bg-white dark:bg-gray-800 text-blue-800 rounded-full hover:bg-gray-200">
//           Explore Courses
//         </Button>
//       </div>
//     </div>
